...
namespace hipo {
  ...
  std::string utils::getFileHeader() {
    ...
    file_header.append("   std::cout << \" reading file example program (HIPO) "
                       "\" << std::endl;\n");
    file_header.append("   char inputFile[256];\n\n");
    file_header.append("   if(argc>1) {\n      "
                       "sprintf(inputFile,\"%s\",argv[1]);\n   } else {\n ");
    file_header.append("     std::cout << \" *** please provide a file name...\" "
                       "<< std::endl;\n");
  ...
  std::string utils::getSConstruct() {
    ...
    std__string.append("env = "
                       ...
                       "include\",\"/opt/local/include\",\"/group/"
                       "clas12/packages/lz4/lib\",\"/group/clas12/packages/hipo-io/"
                       "libcpp\"])\n");
    std__string.append("env.Append(ENV = os.environ)\n");
    std__string.append("env.Append(CPPPATH=[\"src/root\",\"src/evio\"])\n");
    std__string.append("env.Append(CCFLAGS=[\"-O2\",\"-fPIC\",\"-m64\",\"-"
                       "fmessage-length=0\",\"-g\"])\n");
    std__string.append("env.Append(LIBPATH=[\"/opt/local/lib\",\"/usr/lib\",\"/usr/local/"
                       "lib\",\"/group/clas12/packages/lz4/"
                       "lib\",\"lib\",\"/group/clas12/packages/hipo-io/lib\"])\n");
    std__string.append("env.Append(CONFIGUREDIR=[\"/group/clas12/packages/lz4/"
                       "lib\",\"/group/clas12/packages/hipo-io/lib\"])\n");
    std__string.append("#=================================================\n");
    ...
    std__string.append("#=================================================\n");
    std__string.append("runFileLoop   = "
                       "env.Program(target=\"runFileLoop\",source=[\"runFileLoop.cc\"])\n");
    return std__string;
  }
} // namespace hipo
